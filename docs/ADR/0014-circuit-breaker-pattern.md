````markdown
# ADR-0014: Circuit Breaker Pattern for Payment Service Resilience
...
- **ADR-0015:** Rate Limiting Strategy (complementary availability tactic)
- **ADR-0016:** Flash Sale Implementation (context for why resilience matters)
````
